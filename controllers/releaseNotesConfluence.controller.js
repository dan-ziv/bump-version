        ...
        $scope.onCreatePageClicked = function () {
            if ( $scope.btnTxt === "Create Page" ) {
                ...
                Confluence.createPage( $scope.pageData )
                    .then( function ( res ) {
                        $scope.btnTxt = "Next";
                        $scope.html_url = res._links.base + res._links.webui;
                        GitHub.setJiraTickets( $scope.pageData.issues.withJiraTicket );
                        GitHub.setNonJiraTickets( $scope.pageData.issues.withOutJiraTicket );
                    } )
                    .catch( function ( e ) {
                        $scope.btnTxt = "Close";
